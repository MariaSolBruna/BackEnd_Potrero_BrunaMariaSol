...
$consulta = "SELECT * FROM ropa WHERE codigo=$codigo";
...
<html lang="en">
    ...
    <body>
        ...
        if(array_key_exists('guardar_cambios',$_POST)){
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE ropa SET tipo='$tipo', marca='$marca', talle='$talle', precio='$precio', imagen='$imagen' WHERE codigo=$codigo";
